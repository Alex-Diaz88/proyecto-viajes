...
async function main() {
    ...
    try {
        ...
        await connection.query(`
            INSERT INTO travel (id, createdAt, title, entry, place, activity, content, idUser)
                VALUES (1, '2021-07-25', 'Escapada a Coriolis', 'Ruta de senderismo por glaciares', 'Coriolis', 'Naturaleza', 'No se trata de una ruta más, no. Este recorrido te va a permitir conocer el mayor glaciar de Coriolis que tiene 23 Km de longitud y nosotros iremos por un sendero de montaña paralelo y por una cota superior durante unos 7 Km acompañandolo en su recorrido.', 1),
                (2, '2021-06-01', 'Ginkana extrema', 'Pon a prueba tu cuerpo en esta experiencia inolvidable', 'Surha', 'Deportes', 'Survivor Race Surha, una carrera de obstáculos que va más allá, transformando y mejorando tu actitud y estilo de vida.  Survivor significa levantarse por la mañana y sentirse capaz de superar todos los obstáculos que nos encontramos día a día; ya sea solo, en pareja, con amigos, amigas o familia.', 2),
                (3, '2020-08-05','Ruta gastronómica en Lubau', 'Te llenarás la barriga en esta magnífica escapada', 'Lubau', 'Gastronomía', 'Desde su hotel recorrerá la capital, estando junto a todos los centros de interés, culturales y de ocio de la ciudad. Sumergido en la cultura del vino, en la inquitud artística y arquitectónica de la ciudad y en el placer de recorrerla disfutando de ella y al terminar estar en la misma puerta del hotel. Ofrece wifi gratuito, prensa y dispone también de garaje (consultar precios) No se admiten mascotas.', 3),
